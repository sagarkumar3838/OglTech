-- ============================================
-- COMPLETE TOPIC REFERENCES SETUP
-- Step 1: Create table
-- Step 2: Seed data
-- ============================================

-- ============================================
-- STEP 1: CREATE TOPIC_REFERENCES TABLE
-- ============================================
...
-- ============================================
-- STEP 2: SEED TOPIC REFERENCES DATA
-- ============================================
...
-- Success message
SELECT 'Topic references setup complete! Table created and data seeded.' as status;
